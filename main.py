...
# https://legacy.cryptool.org/en/cto/aes-step-by-step (Used to check the correctness of the functions)
...
def sub_word(word): # Application of the AES S-box to each byte of the word
    word = tuple(word)
